...
\subsection*{Average Energy}
  We calculated the average energy as a weighted average of the energies determined above and using the distribution specified in the report writeup. The average energy was $7.79 * 10^{-14}$ J and was calculated as $0.15 * 3.95 x 10^{-13} J + 0.1 * 4.78 x 10^{-14} + 0.1 * 3.89 x 10^{-14} J + 0.65 * 1.54 x 10^{-14} J
